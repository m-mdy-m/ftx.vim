...
function! ftx#async#state#ensure() abort
...
function! ftx#async#state#init(...) abort
  call ftx#async#state#ensure()
  if a:0
...
" --- Task helpers ---
function! ftx#async#state#next_task_id() abort
  call ftx#async#state#ensure()
...
function! ftx#async#state#add_task(task) abort
  call ftx#async#state#ensure()
  call add(g:ftx_async.tasks, a:task)
endfunction

function! ftx#async#state#pop_task() abort
  call ftx#async#state#ensure()
...
function! ftx#async#state#peek_task() abort
  call ftx#async#state#ensure()
  if empty(g:ftx_async.tasks)
    return v:null
  endif
...
function! ftx#async#state#tasks_len() abort
  call ftx#async#state#ensure()
  return len(g:ftx_async.tasks)
endfunction

function! ftx#async#state#clear_tasks() abort
  call ftx#async#state#ensure()
  let g:ftx_async.tasks = []
endfunction

function! ftx#async#state#remove_task_by_id(id) abort
  call ftx#async#state#ensure()
...
" --- Worker helpers ---
function! ftx#async#state#add_worker(worker) abort
  call ftx#async#state#ensure()
  call add(g:ftx_async.workers, a:worker)
endfunction

function! ftx#async#state#remove_worker_by_timer(timer_id) abort
  call ftx#async#state#ensure()
...
function! ftx#async#state#find_worker(timer_id) abort
  call ftx#async#state#ensure()
...
function! ftx#async#state#workers_len() abort
  call ftx#async#state#ensure()
  return len(g:ftx_async.workers)
endfunction

function! ftx#async#state#clear_workers() abort
  call ftx#async#state#ensure()
  let g:ftx_async.workers = []
endfunction

" --- Config getters/setters ---
function! ftx#async#state#get_max_workers() abort
  call ftx#async#state#ensure()
  return g:ftx_async.max_workers
endfunction

function! ftx#async#state#set_max_workers(n) abort
  if a:n <= 0
